    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/apps/**","/administrator/**","/bicycleManager/**","/bicycleManager/add",
                                "/bicycleManager/home","/bicycleManager/home/**","/bicycleManager/home/*/edit","/bicycleManager/home/*/remove").authenticated())
